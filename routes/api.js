...
var creatorList = ['@zahirrr','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@yogiganssss','@zhirrganteng','@zahirrgantengg'];
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------YogiGans'+'YOGI--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'yogigans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'yogigans') return res.json(loghandler.invalidKey)
